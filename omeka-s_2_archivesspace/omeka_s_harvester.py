...
import truststore
truststore.inject_into_ssl()  # Forces Python to use system CA store
...
BASE_URL        = 'https://archives.library.wcsu.edu/omeka-s/api/items'+'?datetime[0][join]=and&datetime[0][field]=created&datetime[0][type]=>&datetime[0][val]='+str(yesterday)  # Replace if needed
...
output_file = '/home/archivesspace/omeka_s_items_output.csv'
